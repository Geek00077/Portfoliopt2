...
// ── API Routes --------------------------
// Mount the Slugcat and user routers under their respective base paths.
// All routes defined in SlugcatsRoutes.js are prefixed with /api/Slugcats
// All routes defined in userRoutes.js are prefixed with /api/users
app.use('/api/Slugcats', require('./routes/SlugcatRoutes'))
